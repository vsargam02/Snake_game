...
#part 3 draw a snake
def snake(blockSize,snakelist): # number of chunks eating and inc
...
# logic 4 draw snake / draw rectangles
        snake(blockSize, snakelist)

        pygame.display.update()

#logic 5 for eat apple and increase a length
